...
1. Read the [current status](../CURRENT_STATUS.md).
2. Read the [reviewer guide](REVIEWER_GUIDE.md).
3. Complete the appropriate track or tracks in the [Phase 5E checklist](PHASE_5E_EXTERNAL_REVIEW_CHECKLIST.md).
4. Record concerns in the [feedback register](FEEDBACK_REGISTER.md).
5. The owner documents resolution of substantive findings.
6. A separate, explicit owner decision is required before any later interface work.
